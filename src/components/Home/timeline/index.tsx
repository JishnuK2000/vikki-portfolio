          ...
          >
            <div className="flex flex-col gap-4">
              <p className="text-white font-medium">
                Designed for the{" "}
                <span className="text-primary">bold & fearless</span>
              </p>
              <h2 className="text-white sm:text-40 text-30 font-medium lg:w-80% mx-auto mb-20">
                Meet OGRE — a bold and unapologetic streetwear brand born from
                my imagination. It's a fusion of funk, grit, and attitude,
                crafted to make a statement wherever it goes.
              </h2>
            </div>
          </motion.div>
          <CompanyProfile />
