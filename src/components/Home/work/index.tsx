  ...
  const services = [
    {
      ...
      text: "Creative designs tailored to your brand identity",
    },
    {
      icon: "/images/chooseus/chooseus-icon-2.svg",
      text: "On-time delivery with professional communication",
    },
    {
      icon: "/images/chooseus/chooseus-icon-3.svg",
      text: "Unique visuals that leave a lasting impression",
    },
  ];
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              <h2 className="sm:text-40 text-30 text-white lg:w-full md:w-70% font-medium">
                I combine creativity and strategy to deliver standout visual
                designs
              </h2>
            </div>
